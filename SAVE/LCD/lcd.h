...
//显示屏 ：1：使用tft 0：使用oled
#define USE_SPI_TFT  1


//SPI显示屏接口
//LCD_RST
#define SPILCD_RST_SET  GPIO_SetBits(GPIOC, GPIO_Pin_5)//PC5
#define SPILCD_RST_RESET GPIO_ResetBits(GPIOC, GPIO_Pin_5)//PC5  
//LCD_RS//dc  
#define SPILCD_RS_SET  GPIO_SetBits(GPIOC, GPIO_Pin_4)//PC4 
#define SPILCD_RS_RESET  GPIO_ResetBits(GPIOC, GPIO_Pin_4)//PC4  
//LCD_CS  
#define SPILCD_CS_SET GPIO_SetBits(GPIOA, GPIO_Pin_0)//PA4 
#define SPILCD_CS_RESET  GPIO_ResetBits(GPIOA, GPIO_Pin_0)//PA4 
...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_REST PAout(1) //LCD REST    		 PB1 	    
//LCD地址结构体
typedef struct
{
	u16 LCD_REG;
